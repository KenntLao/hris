...
<h1><a href="{{ route('jobPositions.index') }}">Job Positions</a></h1>
@stop
@section('content')
<div class="row no-gutters">
	<div class="col-12 box">
		...
		<div class="form-box">
			<form class="form-horizontal" method="post" action="{{ route('jobPositions.create') }}">
				@csrf
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="job_description" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<select class="form-control" name="employment_type">
						...
						<option value="{{$benefit->name}}">{{$employmentType->name}}</option>
						@endforeach
					</select>
					@else
					<select class="form-control" name="employment_type">
