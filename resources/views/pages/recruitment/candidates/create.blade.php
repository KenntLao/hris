...
<div class="row no-gutters">
	<div class="col-12 box">
		...
		<div class="form-box">
			<form class="form-horizontal" method="post" action="{{ route('candidates.create') }}">
				@csrf
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="resume_headline">
				</div>
				<div class="form-group">
					<label for="profile_summary">Profile Summary:</label>
					<input class="form-control" type="text" name="profile_summary">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="work_history">
				</div>
				<div class="form-group">
