...
<h1><a href="{{ route('candidates.index') }}">Candidates</a></h1>
@stop
@section('content')
<div class="row no-gutters">
	<div class="col-12 box">
		...
		<div class="form-box">
			<form class="form-horizontal" method="post" action="{{ route('candidates.update',$candidate->id) }}">
				@csrf
				@method('PATCH')
				<div class="form-group">
					...
					<select class="form-control" name="position_applied" required>
						...
						<option value="{{$jobPosition->name}}">{{$jobPosition->name}}</option>
						@endforeach
					</select>
					@else
					<select class="form-control" name="position_applied" required>
				...
				<div class="form-group">
					...
					<select class="form-control" name="country" required>
						<option value="{{ $candidate->country }}">{{ $candidate->country }}</option>
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="resume_headline" value="{{ $candidate->resume_headline }}">
				</div>
				<div class="form-group">
					<label for="profile_summary">Profile Summary:</label>
					<input class="form-control" type="text" name="profile_summary" value="{{ $candidate->profile_summary }}">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="work_history" value="{{ $candidate->work_history }}">
				</div>
				<div class="form-group">
					<label for="education">Education:</label>
					<input class="form-control" type="text" name="education" value="{{ $candidate->education }}">
				</div>
				<div class="form-group">
